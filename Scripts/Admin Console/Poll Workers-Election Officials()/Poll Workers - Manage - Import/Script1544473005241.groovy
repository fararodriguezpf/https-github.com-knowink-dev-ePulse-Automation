...
WebUI.navigateToUrl(GlobalVariable.Poll_Workers, FailureHandling.STOP_ON_FAILURE)

WebUI.delay(1)

WebUI.click(findTestObject('Admin Console ePulse Menu/Poll Workers/Poll Workers - Manage Page/Import Poll Workers'))

WebUI.setText(findTestObject('Admin Console ePulse Menu/Account Settings/Prompts/Import Prompts Buttons/Choose File'), '/Users/alonzomack/Downloads/Automation uploads/poll_workers.csv')
