...
WebUI.navigateToUrl(GlobalVariable.Ballot_Types)

WebUI.delay(1)

WebUI.click(findTestObject('Admin Console ePulse Menu/Election Setup/Ballot Styles/Import'))

WebUI.setText(findTestObject('Common ePulse Objects/Choose File'), '/Users/alonzomack/Downloads/Automation uploads/ballot_types.csv')
