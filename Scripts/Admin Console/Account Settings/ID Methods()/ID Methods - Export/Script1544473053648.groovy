...
WebUI.navigateToUrl(GlobalVariable.voter_id_methods)

WebUI.delay(1)

WebUI.click(findTestObject('Admin Console ePulse Menu/Account Settings/ID Methods/ID Methods Page/Export'))
