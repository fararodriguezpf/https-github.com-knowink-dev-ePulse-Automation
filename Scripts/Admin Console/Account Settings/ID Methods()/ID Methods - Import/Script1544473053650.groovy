...
WebUI.click(findTestObject('Admin Console ePulse Menu/Account Settings/ID Methods/ID Methods Page/Import'))

WebUI.setText(findTestObject('Admin Console ePulse Menu/Account Settings/Prompts/Import Prompts Buttons/Choose File'), '/Users/alonzomack/Downloads/Automation uploads/voter_id_methods.txt')
