...
WebUI.navigateToUrl(GlobalVariable.Add_Edit_Voter_Import, FailureHandling.STOP_ON_FAILURE)

WebUI.delay(1)

WebUI.setText(findTestObject('Admin Console ePulse Menu/Account Settings/Prompts/Import Prompts Buttons/Choose File'), '/Users/alonzomack/Downloads/Automation uploads/add_voter.txt')
