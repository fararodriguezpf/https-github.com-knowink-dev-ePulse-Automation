...
WebUI.navigateToUrl(GlobalVariable.Prompts_Imports, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Admin Console ePulse Menu/Account Settings/Prompts/Import Prompts Buttons/Choose File'), '/Users/alonzomack/Downloads/prompts-3.txt')
