...
WebUI.setText(findTestObject('Admin Console ePulse Menu/Account Settings/Add User/input_E-mail'), 'addnew4-user@knowink.com')

WebUI.delay(1)

WebUI.selectOptionByValue(findTestObject('Admin Console ePulse Menu/Account Settings/Add User/Select Epulse User'), '3', 
    true)
