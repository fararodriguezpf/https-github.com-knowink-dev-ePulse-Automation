...
WebUI.click(findTestObject('SuperAdminConsole/Edit Accounts - Actions/Delete'))

WebUI.delay(1)

WebUI.click(findTestObject('SuperAdminConsole/Poll Pads/Delete/Actions - Delete/Delete Button'))
