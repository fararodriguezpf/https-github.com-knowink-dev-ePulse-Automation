...
WebUI.click(findTestObject('SuperAdminConsole/STATUS/Edit Absentee Status'))

WebUI.delay(1)

WebUI.setText(findTestObject('SuperAdminConsole/STATUS/Input_Status_Custom Name'), 'Custome Name')
